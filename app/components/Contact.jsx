...
const Contact = () => {
  ...
  return (
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center mb-2 text-lg font-Ovo'>Connect With Shivendra</motion.h4>
        <motion.h2 
        initial={{opacity: 0, y: -20}}
        whileInView={{opacity: 1, y:0}}
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
          <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            className='flex-1 p-3 outline-none border-[0.5px]
            border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='email'/>
          ...
          border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90' name='message'>
          ...
          gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black 
