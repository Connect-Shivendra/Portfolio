...
const Contact = () => {
  ...
  return (
    <motion.div 
      ...
      id='contact' className='w-full px-[12%] py-10 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'> {/* Removed scroll-mt, fixed quotes */}
        <motion.h4 
