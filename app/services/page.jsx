...
const ServicesPage = () => {
  ...
  return (
    <>
      <Navbar />
      <div id="services" className='w-full px-[8%] py-12 bg-[var(--background)]'>
        <motion.div
        ...
        >
          ...
          >
            <motion.h4
              ...
              className='text-lg font-Ovo text-[var(--text-secondary)] tracking-wide uppercase mb-1'
            >
          ...
          <motion.section
            ...
            variants={slideUp}
          >
            <h2 className="text-3xl font-semibold text-[var(--text-primary)] mb-6">Our Service Philosophy</h2>
          ...
          <motion.section
            ...
            variants={slideUp}
          >
            <h2 className="text-3xl font-semibold text-[var(--text-primary)] mb-6">How We Work</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div
                className="bg-[var(--card-bg)] p-6 rounded-lg shadow-sm"
                variants={fadeIn}
              >
                ...
                <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2 text-center">Discover</h3>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2 text-center">Design</h3>
                <p className="text-[var(--text-secondary)] text-center">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2 text-center">Deliver</h3>
                <p className="text-[var(--text-secondary)] text-center">
          ...
          <motion.section
            ...
            variants={slideUp}
          >
            <h2 className="text-3xl font-semibold text-[var(--text-primary)] mb-6">Why Choose Our Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-1">Industry Expertise</h3>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-1">Collaborative Approach</h3>
                  <p className="text-[var(--text-secondary)]">
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-1">Results-Focused</h3>
                  <p className="text-[var(--text-secondary)]">
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-1">Technology Agnostic</h3>
                  <p className="text-[var(--text-secondary)]">
